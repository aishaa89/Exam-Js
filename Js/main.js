...
$('.fa-bars').on('click',function(){
 ...
 $(function(){
    $('.fa-spinner').fadeOut(5000 ,function(){
    ...
    for(let i=0;i<detail.meals.length;i++){
     ...
     <div class="col-md-8">
         ...
         <p> ${detail.meals[i].strInstructions} </p>
          ...
          <li class="alert alert-info m-2 p-1">${detail.meals[i].strMeasure1}+${detail.meals[i].strIngredient1}</li>
          <li class="alert alert-info m-2 p-1">${detail.meals[i].strMeasure2}+${detail.meals[i].strIngredient2}</li>
          <li class="alert alert-info m-2 p-1">${detail.meals[i].strMeasure3}+${detail.meals[i].strIngredient3}</li>
          <li class="alert alert-info m-2 p-1">${detail.meals[i].strMeasure4}+${detail.meals[i].strIngredient4}</li>

            </ul>
            <h3>Tags :</h3>
            <ul class="list-unstyled d-flex g-3 flex-wrap" id="Tags">
            <li class="alert alert-info m-2 p-1">${detail.meals[i].strTags}</li>
            </ul>
...
for(let i=0;i<areas.meals.length;i++){
    ...
    <div id="${areas.meals[i].strArea}" class="area-point text-center text-light bg-danger">
...
form.addEventListener("change",() => {
    if( validateName()==true&&validateEmail==true&&validatephone==true&&validatepassword==true&&validateRepassword==true){
